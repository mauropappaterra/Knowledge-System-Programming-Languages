...
born(fortran,1957).
application_field(fortran,research). 
...
paradigm(lisp,meta).
born(lisp,1958).
application_field(lisp,artificial_intelligence). 
...
born(prolog,1972).
application_field(prolog,artificial_intelligence). 
...
born(sql,1974).
application_field(sql,databases). 
...
born(c_pp,1983).
application_field(c_pp,software).  
...
born(latex,1985).
application_field(latex,mathematics).  
...
born(perl,1987).
application_field(perl,embedded). 
...
application_field(mathematica,mathematics).
...
born(haskell,1990).
application_field(haskell,mathematics). 
...
born(python,1991).
application_field(python,software).  
...
born(racket,1994).
application_field(racket,artificial_intelligence).
...
born(java,1995).
application_field(java,software).  
...
born(c_sharp,2000).
application_field(c_sharp,software).  
